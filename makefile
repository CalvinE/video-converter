...
run-docker-container:
	docker run -it --volume F:/source:/source --volume D:/result:/result --volume D:/logs:/root/video-converter/logs $(image_name):$(version)
...
run-nvidia-enabled-docker-container:
	docker run -it --gpus all --volume F:/source:/source --volume D:/result:/result --volume D:/logs:/root/video-converter/logs $(image_name):$(version)$(nvidia_tag)